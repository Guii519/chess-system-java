...
public class ChessMatch {
    ...
    private Piece makeMove(Position source, Position target){
        ...
        if(capuredPiece != null){
            ...
            capturedPieces.add(capuredPiece);
        }

        //Spacial move castling king side rook
        ...
        //Spacial move castling queen side rook
        if (p instanceof King && target.getColumn() == source.getColumn() - 2){
        ...
        if (p instanceof Pawn){
            if (source.getColumn() != target.getColumn() && capuredPiece == null){
                ...
                capuredPiece = board.removePiece(pawPosition);
                capturedPieces.add(capuredPiece);
                piecesOnTheBoard.remove(capuredPiece);
            }
        }
